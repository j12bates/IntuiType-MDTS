...
### Levels
Any setting can be made to apply to certain block levels in addition to a particular block type.

A property of a block type subschema can be named with a setting's property name with one of the following suffixes:
- `_highest`
- `_scale`
- `_scale_limit`
- `_list`
